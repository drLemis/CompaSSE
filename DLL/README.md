...
`translation_table.bin` is a binary file containing cross-version ID
remappings. Structure:
...
The table contains 925 remapped IDs from 8 version tables. Applied after
merging, these overwrite offset values for IDs whose addresses changed
